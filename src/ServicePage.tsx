...
import type { ServicePage as ServicePageData } from "./services";

/**
 * Standalone service landing page, rendered to static HTML at build time (see prerender.tsx)
 * for SEO. Mirrors BlogArticlePage's layout/design tokens so it inherits the design system
 * from the shared compiled CSS bundle. Must stay browser-API free.
 */
