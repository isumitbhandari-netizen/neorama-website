...
export const SOCIAL_REELS: SocialReel[] = [
  ...
  { id: "knotted-fashion",   client: "knotted.in",        title: "Fashion Content",              category: "Fashion",         thumbnail: "/images/social/knotted-fashion.webp",   vimeoId: "1199863602", gradient: "linear-gradient(145deg,#0d2b1a 0%,#1e5c38 50%,#2d8a55 100%)" },
  { id: "linen-festive-1",   client: "Linen and Linens",  title: "Festive Campaign Reel 1",      category: "Fashion",         thumbnail: "/images/social/linen-festive-1.webp",   vimeoId: "1199863737", gradient: "linear-gradient(145deg,#3b2510 0%,#8a5c2e 50%,#c49455 100%)" },
  { id: "linen-festive-2",   client: "Linen and Linens",  title: "Festive Campaign Reel 2",      category: "Fashion",         thumbnail: "/images/social/linen-festive-2.webp",   vimeoId: "1199863727", gradient: "linear-gradient(145deg,#3b2510 0%,#7a4c20 50%,#b07840 100%)" },
  { id: "linen-social-1",    client: "Linen and Linens",  title: "Social Media Campaign Reel 1", category: "Fashion",         thumbnail: "/images/social/linen-social-1.webp",    vimeoId: "1199863688", gradient: "linear-gradient(145deg,#2a1c0e 0%,#6e4422 50%,#a06838 100%)" },
  { id: "linen-social-2",    client: "Linen and Linens",  title: "Social Media Campaign Reel 2", category: "Fashion",         thumbnail: "/images/social/linen-social-2.webp",    vimeoId: "1199863686", gradient: "linear-gradient(145deg,#2a1c0e 0%,#5e3818 50%,#905830 100%)" },
  ...
  { id: "simhayana-fashion", client: "Simhayana",         title: "Fashion Reel",                 category: "Fashion",         thumbnail: "/images/social/simhayana-fashion.webp", vimeoId: "1199863601", gradient: "linear-gradient(145deg,#2a0808 0%,#7a1818 50%,#c43030 100%)" },
